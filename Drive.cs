...
namespace Sello
{
    public partial class Drive : Form
    {
        ...
        private static readonly string username = "example@gmail.com";
        private static readonly string ApplicationName = "SelloDrive";
        private static readonly string ClientId = "12345abcdefg.apps.googleusercontent.com"; //Change this
        private static readonly string RedirectUri = "http://127.0.0.1:3301/authorize";
        private static readonly string ClientSecret = "ABCD-ASDFGHJKASD"; //Change this
